...
namespace TAF.Utility
{
    ...
    public static class Web
    {
        ...
        public static T GetSession<T>(string key)
        {
            ...
            return HttpContext.Current.Session[key].To<T>();
        }
        ...
        /// </summary>
        /// <param name="url">
        /// Http地址，范例：http://www.test.com/a.rar 
        /// </param>
        /// <param name="fileName">
        /// 文件名，包括扩展名
        /// </param>
        ...
        public static void Download(byte[] bytes, string fileName, Encoding encoding)
        {
            ...
            HttpContext.Current.Response.AddHeader(
                                                   "Content-Disposition",
                "attachment; filename=" + UrlEncode(fileName.Replace(" ", String.Empty)));
