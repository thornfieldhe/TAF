...
namespace TAF.Test
{
    ...
    public class StringExtensionTest
    {
        ...
        {
            string pinyin = null;
            Assert.AreEqual(string.Empty, pinyin.GetChineseSpell());
            pinyin = string.Empty;
            Assert.AreEqual(string.Empty, pinyin.GetChineseSpell());
        ...
        {
            string a = null;
            Assert.AreEqual(string.Empty, a.Truncate(4));
            a = string.Empty;
            Assert.AreEqual(string.Empty, a.Truncate(4));
        ...
        {
            string a = null;
            Assert.AreEqual(string.Empty, a.GetLastProperty());
            Assert.AreEqual(string.Empty, string.Empty.GetLastProperty());
        ...
        {
            Assert.AreEqual("123", (new List<int> { 1, 2, 3 }).Splice(string.Empty, string.Empty));
        }
        ...
        {
            Assert.AreEqual("1 2 3", (new List<int> { 1, 2, 3 }).Splice(string.Empty, " "));
        }
