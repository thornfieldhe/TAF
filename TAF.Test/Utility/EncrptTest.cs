...
namespace TAF.Test
{
    ...
    public class Md5Test
    {
        ...
        {
            Assert.AreEqual(string.Empty, Encrypt.Md5By16(null));
            Assert.AreEqual(string.Empty, Encrypt.Md5By16(string.Empty));
        }
        ...
        {
            Assert.AreEqual(string.Empty, Encrypt.Md5By32(null));
            Assert.AreEqual(string.Empty, Encrypt.Md5By32(string.Empty));
        }
